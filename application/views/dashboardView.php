              ...
              <li>
                ...
                <ul class="menu inner-content-div">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="assets/<?php echo base_url()?>images/user2-160x160.jpg" class="rounded-circle" alt="User Image">
                      </div>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url()?><?php echo base_url()?>assets/images/user3-128x128.jpg" class="rounded-circle" alt="User Image">
                      </div>
                      <div class="mail-contnet">
                         <h4>
                          Nullam tempor
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="assets/<?php echo base_url()?>images/user4-128x128.jpg" class="rounded-circle" alt="User Image">
                      </div>
                      <div class="mail-contnet">
                         <h4>
                          Donec tempor
...
<!-- ./wrapper -->
	...
	<!-- Fab Admin App -->
	<script src="<?php echo base_url()?>assetsjs/template.js"></script>

	<!-- Fab Admin dashboard demo (This is only for demo purposes) -->
	<script src="<?php echo base_url()?>assetsjs/pages/dashboard.js"></script>
